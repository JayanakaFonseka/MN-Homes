      ...
      <div class="row">
        ...
        <div class="col-lg-3 mb-4">
          <div class="list-group text-center" >
            ...
            <a href="<?php echo base_url('SiteOfficer/viewattendance'); ?>" class="list-group-item">Mark Attendence</a>
            <a href="<?php echo base_url('SiteOfficer/projectprogress'); ?>" class="list-group-item active">Project progress</a>
